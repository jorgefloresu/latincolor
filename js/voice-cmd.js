...
function startButton(event) {
    ...
    if (annyang) {
        ...
        var commands = {
            'show me *keyword': function(keyword) {
                $('#search').val(keyword);
                $('#keyword').val(keyword);
                $('.icon-search').click();
            },
            'set :type option': function(type) {
                $('#'+type).click();
                Materialize.toast('Cambio de opción a '+type,4000);
            },
            'next page': function(){
                $('a[rel=next]').click();
            },
            ...
            'filter by *option': function (option) {
                console.log(option);
                switch (option) {
        ...
        annyang.addCallback('error', onerror);
