...
class RpcParams
{
    ...
    const GET_RELATED_CMD       = 'getRelated';
    ...
    const SEARCH_VIDEO  = 'dp_search_video';
    ...
    const RELATED_TYPE      = 'dp_related_type';
    const RELATED_SEARCH_ID = 'dp_search_item_id';
    const RELATED_LIMIT     = 'dp_limit';
