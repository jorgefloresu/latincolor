<?php $this->load->view('templates/header')?>
  ...
  <main class="servicios">
    <div id="index-banner" class="parallax-container">
      ...
      <div class="parallax"><img src="<?php echo base_url('img/servicios.jpg')?>" alt="Servicios"></div>
    </div>
      ...
      <div class="container">
          <div class="row">
            <div class="col s12 m12 l6">
                  <?php echo material_servicio_card('brown-layout','img/drone.gif',
            ...
            <div class="col s12 m12 l6">
              <?php echo material_servicio_card('brown-layout','img/foto-producto.jpg',
          ...
          <div class="row">
            <div class="col s12 m12 l6">
                  <?php echo material_servicio_card('brown-layout','img/foto-produce.jpg',
            ...
            <div class="col s12 m12 l6">
                  <?php echo material_servicio_card('brown-layout','img/cubrimiento.jpg',
          ...
          <div class="row">
            <div class="col s12">
              <?php echo material_servicio_card('brown-layout','img/360.gif',
          ...
          <div class="row">
            <div class="col s12 center" style="margin:20px 0">
                    ...
                    <a href="<?php echo base_url('main/consultor')?>" class="btn-large waves-effect waves-light blue accent-3">Mi Consultor</a>
            </div>
          </div>
    </div>
    </div>
