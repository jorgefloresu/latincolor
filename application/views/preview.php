  ...
  <div class="imgdetail modal">
    ...
    <div class="row" style="width:97%">
                ...
                <div id="prices" class="card" style="margin:0 0 20px 0">
                  <!-- <div class="card-image" style="height: 50px;border-bottom: 1px solid #CCC;background-color:#e0e0e0">
                    ...
                    <div class="card-action">
                      <a href="<?=site_url('main/planes')?>" class="waves-effect waves-light btn"
                        style="background-color: transparent;border: .12rem solid #f12088;color: #f12088;">
                        Ver planes</a>
                      <a href="#" class="menu-cart waves-effect waves-light btn" style="background-color:#1c9414;margin-left:20px">Ir al carrito</a>
                    </div>
                </div>
      ...
      <div class="row container similar-container">
        <div><h5>Imágenes relacionadas</h5></div>
      ...
      <div class="row container similar-container">
        <table>
          <thead>
            <tr><td>Palabras clave</td></tr>
          </thead>
          <tbody>
            <tr><td><p id="keywords-preview" class="grey-text" style="font-size: 11px;line-height:1rem"></p></td></tr>
          </tbody>
        </table>
