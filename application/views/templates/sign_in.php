    ...
    <?php echo form_open('login/validate_credentials', 'id="login-form" class="login-form" novalidate'); ?>
      ...
      <div class="row margin">
        <div class="input-field col s6 m6 l6">
          <p class="margin medium-small"><a href="#" class="create-account">Create Account</a></p>
        </div>
        <div class="input-field col s6 m6 l6">
          <p class="margin right-align medium-small"><a href="#" class="forgot-password">Forgot Password</a></p>
        </div>
      </div>
    <?php echo form_close(); ?>
    </div>
