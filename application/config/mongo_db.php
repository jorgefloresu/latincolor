...
$config['mongo_db']['default']['hostname'] = 'ds060009.mlab.com';
$config['mongo_db']['default']['port'] = '60009';
$config['mongo_db']['default']['username'] = 'jorgeflores';
$config['mongo_db']['default']['password'] = 'jafu6921';
$config['mongo_db']['default']['database'] = 'ci_test';
